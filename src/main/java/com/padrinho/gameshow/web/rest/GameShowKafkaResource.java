...
@RestController
@RequestMapping("/api/game-show-kafka")
public class GameShowKafkaResource {

    private final Logger log = LoggerFactory.getLogger(GameShowKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public GameShowKafkaResource(KafkaProperties kafkaProperties) {
